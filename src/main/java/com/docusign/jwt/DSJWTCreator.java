...
import com.docusign.jwt.impl.ClaimsHolder;
import com.docusign.jwt.impl.PayloadSerializer;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.MapperFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.module.SimpleModule;

public class DSJWTCreator {

	private final Algorithm algorithm;
	private final String headerJson;
	private final String payloadJson;

	private DSJWTCreator(Algorithm algorithm, Map<String, Object> headerClaims, Map<String, Object> payloadClaims)
	 ...
	 */
	static DSJWTCreator.Builder init() {
		return new Builder();
	}
	...
	public static class Builder {
		 ...
		 *
		 * @param headerClaims
		 *            the values to use as Claims in the token's Header.
		...
		/**
		 * Add a specific Key Id ("kid") claim to the Header. If the
		 * {@link Algorithm} used to sign this token was instantiated with a
		 * KeyProvider, the 'kid' value will be taken from that provider and
		 ...
		 * @throws JWTCreationException
		 *             if the claims could not be converted to a valid JSON or
		...
		public String sign(Algorithm algorithm) throws IllegalArgumentException, JWTCreationException {
			...
			return new DSJWTCreator(algorithm, headerClaims, payloadClaims).sign();
		}
